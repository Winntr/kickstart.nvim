...
wk.add({
  ...
  -- help/hide/debug moved to <leader>? to free <leader>h for harpoon
  { '<leader>?', group = '[?] help / hide / debug' },
  { '<leader>?c', group = '[c]onceal' },
  { '<leader>?ch', ':set conceallevel=1<cr>', desc = '[h]ide/conceal' },
  { '<leader>?cs', ':set conceallevel=0<cr>', desc = '[s]how/unconceal' },
  { '<leader>?t', group = '[t]reesitter' },
  { '<leader>?tt', vim.treesitter.inspect_tree, desc = 'show [t]ree' },
  ...
  { '<leader>vr', group = '[R]esession / sessions' },
